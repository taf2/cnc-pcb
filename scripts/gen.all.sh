...
/usr/bin/ruby scripts/post-laser-makera.rb flatcam/step3-top-silk.nc 003 -0.2 0.1
...
/usr/bin/ruby scripts/post-laser-makera.rb flatcam/step7-bot-silk.nc 003 -0.2 0.1
